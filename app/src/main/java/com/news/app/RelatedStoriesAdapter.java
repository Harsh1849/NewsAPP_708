...
public class RelatedStoriesAdapter extends RecyclerView.Adapter<RelatedStoriesAdapter.ViewHolder> {
    ...
    public RelatedStoriesAdapter(Context context, ArrayList<Article> arrayList, NavController navController, NewsDataModel newsDataModel, MainViewModel mainViewModel) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.list_item_related_news, parent, false);
...
//            bundle.putString(NEWSLIST, new Gson().toJson(newsDataModel, NewsDataModel.class));
            navController.navigate(R.id.nav_action_nav_news_detail, bundle);
        });
    }
